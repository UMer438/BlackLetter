...
export function Docket({ onUpload, isUploading, uploadStatus, fileName }: DocketProps) {
    ...
    return (
        <div className="w-full md:w-72 bg-[#0B1120] text-gray-300 h-screen flex flex-col border-r border-gray-800 shadow-2xl z-10 transition-all duration-300 pb-20 md:pb-0">
